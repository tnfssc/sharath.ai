  ...
  return (
    <section className="px-6 py-20 md:px-8">
      <div className="mx-auto max-w-2xl">
        <h1 className="mb-10 text-3xl font-medium tracking-tight md:text-4xl"><span style={{ viewTransitionName: 'blog-heading' }}>Blog</span></h1>
        ...
        {posts.length === 0 ? (
          ...
          <ul className="divide-y divide-base-300">
            {posts.map((post) => (
              <li key={slugOf(post)} className="py-6 first:pt-0 last:pb-0">
                <Link
                  to="/blog/$slug"
                ...
                >
                  <div className="flex gap-4">
                    <div className="min-w-0 flex-1">
                      <time className="text-xs tabular-nums text-base-content/65 transition-colors group-hover:text-base-content/85">
                      ...
                      <h2 className="mt-1 font-display text-lg font-medium leading-snug group-hover:text-primary text-balance">
                        <span className="link-draw" style={{ viewTransitionName: `post-title-${slugOf(post)}` }}>
                          {post.title}
                        </span>
                      </h2>
                      ...
                      <div className="mt-2 flex items-center gap-2">
                        ...
                        <span className="text-xs text-base-content/65 transition-colors group-hover:text-base-content/85">{post.author.name}</span>
                      </div>
