...
/**
 * Four social link icons (Twitter, LinkedIn, GitHub, YouTube) with three
      ...
      {socials.map(({ name, href, Icon, Fill, fill }) => (
        ...
        >
          <Magnetic strength={0.5}>
            <span className="relative inline-flex block transition-transform duration-200 ease-out group-hover:-translate-y-0.5">
